    ...
    try {
        ...
        while (!window.shouldClose()) {
            ...
            if (ImGui::Begin("Spell HUD", NULL, hudFlags)) {
                ...
                if (!uiMode) {
                    if (left && right) {
                        ImGui::TextColored(ImVec4(0.8f, 0.2f, 1.0f, 1.0f), u8"虚式「茈」");
                        ImGui::TextColored(ImVec4(0.8f, 0.2f, 1.0f, 1.0f), u8"むらさき");
                    }
                    else if (left) {
                        ImGui::TextColored(ImVec4(0.2f, 0.8f, 1.0f, 1.0f), u8"術式順転『蒼」");
                        ImGui::TextColored(ImVec4(0.2f, 0.8f, 1.0f, 1.0f), u8"あお");
                    }
                    else if (right) {
                        ImGui::TextColored(ImVec4(1.0f, 0.2f, 0.2f, 1.0f), u8"術式反転「赫」");
                        ImGui::TextColored(ImVec4(1.0f, 0.2f, 0.2f, 1.0f), u8"あか");
                    }
                    else {
                        ImGui::TextColored(ImVec4(0.7f, 0.7f, 0.7f, 0.5f), u8"無下限咒術");
                        ImGui::TextColored(ImVec4(0.7f, 0.7f, 0.7f, 0.5f), u8"むかげんじゅじゅつ");
                    }
                }
                else {
